...
\begin{enumerate}
 ...
 \begin{enumerate}
  ...
  \item \label{leer_simple} Leer definiciones de matrices en un formato para matrices dispersas por coordenadas (formato simple). %\footnote{Vea el primer formato definido en la sección 5.1 de Stewart~\cite{stewart}}.
 \end{enumerate}
