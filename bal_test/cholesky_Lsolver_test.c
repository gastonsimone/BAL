...
void cholesky_Lsolver_test()
{
	...
	if (bal_cargar_matriz("./data/matriz_sim_6x6.m", &matriz, &n, &m) == 0) {
		...
		bal_cholesky_Lsolver(spL, b);
		printf("RESULTADO DE Ly=b:\n");
		print_array(b, 6);
		...
		printf("cholesky_Lsolver_test: Error al leer el archivo\n");
}
